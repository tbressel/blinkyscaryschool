        ;Tests the stand-alone sound effects player, for AMSTRAD CPC.
...
StopChannel1:
        xor a
StopChannelShared:
        ;Stops the sound effect on this channel.
...
Main_Player_End:
        ...
        print "Size of music: ", {hex}(SoundEffects_End - SoundEffects_Start)
